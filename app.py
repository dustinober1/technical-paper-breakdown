...
def extract_arxiv_id(input_str):
    ...
    # Match standard ArXiv IDs (e.g., 2310.06825 or 2310.06825v1)
    # Also handles URLs like https://arxiv.org/abs/2310.06825
...
def fetch_arxiv_data(arxiv_id):
    ...
    try:
        ...
        # Note: paper.download_pdf saves to disk. We'll use a temp file.
...
def get_distillation_prompt():
    template = """
    You are an expert technical researcher and instructional designer.
    Analyze the following research paper text and produce a structured study guide.
    ...
    if fetch_btn and arxiv_input:
        ...
        with st.spinner(f"Fetching paper {arxiv_id} from ArXiv..."):
            ...
            if data:
                ...
                st.session_state.messages = [] # Reset chat on new paper
                ...
                with st.spinner("Extracting and processing text..."):
                    ...
                    with st.spinner("Distilling content with LLM..."):
                        ...
                        # Decide strategy based on length
                        # Heuristic: If > 10 chunks, use map_reduce, else stuff
                        if len(chunks) > 10:
